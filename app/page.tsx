...
export default function Home() {
  ...
  return (
    <main className="flex-grow flex flex-col justify-center items-center bg- text-white p-4 min-h-screen">
      <motion.div
...
export default function Home() {
  ...
  return (
    <main
      className="flex-grow flex flex-col justify-center items-center text-white p-4 min-h-screen"
    >
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }}
